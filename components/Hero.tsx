...
const Hero = () => {
  return (
    <div className="pt-10 lg:pt-20 w-full flex flex-col items-center justify-center px-4 bg-[#fff7f8]">
      {/* What's new badge */}
      <div className="mb-8">
      ...
      <div className="w-full max-w-xl space-y-4">
        <div className="flex flex-col sm:flex-row gap-3 bg-white p-2 rounded-xl shadow-[0_4px_60px_rgba(231,90,130,0.35)]">
          ...
          />
          <Button className="h-14 px-8 text-lg font-normal rounded-xl bg-gradient-to-t from-[#b24e55] to-[#E3405F] hover:opacity-90 text-white whitespace-nowrap">
            Find your next role
            <svg
              className="ml-2"
              width="24"
