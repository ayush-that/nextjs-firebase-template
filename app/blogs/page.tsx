  ...
  return (
    <div className="min-h-screen bg-[#fff7f8] flex flex-col items-center justify-center p-4">
      ...
      <h1 className="text-4xl md:text-5xl lg:text-6xl text-center font-mabry font-semibold text-[#403334] max-w-4xl mb-6">
        Our Blog is <span className="text-[#b24e55]">Coming Soon</span>
      </h1>

      <p className="text-lg md:text-xl text-center text-[#4A3D55] max-w-2xl mb-12">
        We're working hard to bring you insightful articles about job hunting,
        career development, and industry trends. Stay tuned!
      </p>
